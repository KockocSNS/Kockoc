 ...
 */
public class ScrapUserAcitivity extends BaseActivityWithoutNav {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        scrapUserRecyclerAdapter = new NeighborRecyclerAdapter(scrapUser, ScrapUserAcitivity.this, new ItemClickListener());
        scrapRecyclerView.setAdapter(scrapUserRecyclerAdapter);
        LinearLayoutManager manager_follower = new LinearLayoutManager(ScrapUserAcitivity.this , LinearLayoutManager.VERTICAL,false);
    ...
    private class ItemClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(ScrapUserAcitivity.this, UserActivity.class);
