...
public class DetailPageData implements Serializable{
    ...
    public void setBoardDate(String date){this.boardDate = date;}
    public void setBoardText(String text) {this.boardText = text;}
    public void setBoardImgArr(ArrayList<String> boardImgArr){this.boardImgArr = boardImgArr;}
    ...
    public String getBoardText(){return this.boardText;}
    public String getBoardDate(){return this.boardDate;}
    public ArrayList<String> getBoardImgArr() {return this.boardImgArr;}
    public ArrayList<String> getCourse() {return this.course;}
    public ArrayList<String> getHashTagArr(){return this.hashTagArr;}
    public ArrayList<Comment> getCommentArr(){return this.commentArr;}
    public String getUserNo(){return  this.userNo;}
    public String getBoardTime(){return this.boardTime;}
    public int getScrapNumber(){return this.scrapNumber;}
    ...
    public class Comment{
        ...
        public void setComment_userNo(int userNo){this.comment_userNo = userNo;}
        public void setComment_userName(String userName){this.comment_userName = userName;}
        public void setComment_profileImage(String comment_profileImage){this.comment_profileImage= comment_profileImage;}
        ...
        public int getComment_userNo(){return this.comment_userNo;}
        public String getComment_userName(){return this.comment_userName;}
        public String getComment_profileImage(){return this.comment_profileImage;}
